export interface Env {
  ...
  FAL_API_KEY: string;
  OPENROUTER_PORTRAIT_REALISTIC_MODEL?: string;
  OPENROUTER_PORTRAIT_STYLIZED_MODEL?: string;
  OPENROUTER_EXPRESSION_REALISTIC_MODEL?: string;
  OPENROUTER_EXPRESSION_STYLIZED_MODEL?: string;
  OPENROUTER_EXPRESSION_REALISTIC_QUALITY?: string;
  OPENROUTER_EXPRESSION_STYLIZED_QUALITY?: string;
  OPENROUTER_BACKGROUND_MODEL?: string;
  OPENROUTER_PORTRAIT_PREVIEW_MODEL?: string;
  OPENROUTER_PORTRAIT_PREMIUM_MODEL?: string;
  IMAGE_JOBS: DurableObjectNamespace;
  IMAGE_EVALUATION_TOKEN?: string;
